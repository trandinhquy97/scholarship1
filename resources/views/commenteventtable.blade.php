        ...
        <table id="sorting-table" class="table mb-0">
            ...
            @foreach($comments as $comment)
                <tr>
                    ...
                    <td>{{str_limit($comment->TenSuKien, 32)}}</td>
                    ...
                    <td class="td-actions">
                        ...
                        <a class="btn-del" href="manage/commentssevent/deletecomment/{{$comment->id_BinhLuan}}" id="{{$comment->id_BinhLuan}}"><i class="la la-close delete"></i></a>
                    </td>
                </tr>
            @endforeach
            </tbody>
